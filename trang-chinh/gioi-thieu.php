...
<head>
    ...
    <link rel="stylesheet" href="/css/danh-sach-sp/style.css">
...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="logo"><a href="../index.php"><h2 style="font-size:28px;font-family:'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif;color:black;">MilkyWay</h2></a></div>
                            <nav class="main_nav">
    ...
    <div style="width: 100%; ">
        <a href="#"><img src="../assets/img/bubble-tea-in-milk-splash-advertisement-banner-free-vector.jpg width="100%"></a>
    </div>
    
    <div class="container" style="margin-top: 80px;">
        <div class="row">
        <div class="col-sm-4">
            <img src="../assets/img/Blueberry Milkshake.jpg" alt="" style = "width:100%;">
        </div>
        <div class="col-sm-8">

        <div class="row">
            <div class="col-sm-12">
                        <h2>TẤT TẦN TẬT VỀ milkyway</h2>
                        <p style = "text-align:justify;">milkway – Hệ thống cửa hàng, Website mua sắm cafe & trà sữa tại Hà Nội, với sứ mạng đưa “nền văn hóa sát mặt đất” đến gần hơn giới trẻ Đà Thành, chúng tôi cam kết mang đến một hương vị mới nhất khổng lồ đến từ nhiều thương hiệu lớn, nhỏ và cả ở Việt Nam. Được trải qua các khâu tuyển lựa kỹ lưỡng sao cho phù hợp thị hiếu, phong cách Á Đông, đồng thời, bắt nhịp cùng xu hướng chung đang thịnh hành khắp thế giới. <br> <br>

Chính thức hoạt động từ năm 2015, đi cùng những cố gắng và nỗ lực không ngừng nghỉ, đến thời điểm hiện tại, milkyway đã đánh dấu mình vào một vị trí vững chắc trong văn hóa cafe & trà ở thị trường miền Bắc vốn còn non trẻ này. 2 năm xây dựng và phát triển, 2 cửa hàng, showroom được ra đời, đều nằm trong các khu vực trung tâm thuộc thành phố Hà Nội và thành phố Tuyên Quang. Thời gian sắp tới. Ngay bây giờ, hãy cùng tìm hiểu vài nét sơ lược về cả 3 chi nhánh “to bự” này nhé!</p>
            </div>
        </div>

        <div class="row">
            <div class="col-sm-12">
                        <h4>CHI NHÁNH MILKYWAY BOBA</h4>
            </div>
        </div>

        <div class="row">
            <div class="col-sm-6" style=" border-right:double #c30005 5px">
            <b>CN1: 222 Đống Đa – Hà Nội</b><br>
            <p style = "text-align:justify;margin-top:10px;">Ra đời vào năm 2015, là đứa con đầu tiên, là cột mốc khởi đầu cho quá trình “vươn mình ra biển lớn” của thương hiệu milkway. Mặc dù, không gian Showroom lúc này chưa thực sự lớn, các dòng sản phẩm, mẫu mã, thiết kế còn hạn chế. Đồng thời, những dịch vụ chăm sóc và hỗ trợ khách hàng vẫn còn rất nhiều thiếu sót. Tuy nhiên, mọi cố gắng không biết mệt mỏi của chúng tôi cuối cùng đã được đền đáp một cách xứng đáng…….</p>
            </div>
            <div class="col-sm-6">
            <b>CN2: Tuyên Quang – Lô D29 đường N10 – Tuyên Quang</b><br>
            <p style = "text-align:justify;margin-top:10px;">……2 năm trôi qua, một Showroom “bé bự” tiếp tục nối gót người anh chập chững đặt chân tại thành phố  Tuyên. Hoàn thiện hơn, mạnh mẽ hơn, không gian cực rộng lớn với các phân khu sản phẩm riêng biệt trải đều trên diện tích hơn 100m2. Nhằm “phổ cập” rộng rãi xu hướng cafe mới cho giới trẻ miền Bắc, đồng thời, trở thành một tụ điểm mua không thể bỏ qua trải dài từ Sơn Dương – Tuyên Quang.</p>
            </div>
        </div>
