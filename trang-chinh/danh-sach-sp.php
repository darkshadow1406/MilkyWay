...
<head>
    ...
    <link rel="stylesheet" href="../../dam/css/danh-sach-sp/plugin/css/owl.carousel.min.css">
    <link rel="stylesheet" href="../../dam/css/danh-sach-sp/plugin/css/owl.theme.default.min.css">
...
<body>
    ...
    <script type="text/javascript" src="../../dam/css/danh-sach-sp/plugin/js/owl.carousel.min.js"></script>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="header_content d-flex flex-row align-items-center justify-content-start">
                            <div class="logo"><a href="../index.php"><h2 style="font-size:28px;font-family:'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif;color:black;">MilkyWay</h2></a></a></div>
                            <nav class="main_nav">
        ...
        <div class="row">
            <div class="col-md-3" style="padding-left: 0px;margin-top: 42px;">
                ...
                <div class="row" style="margin-left: 0px;">
                    ...
                    <!-- CODE PHP DANH MỤC -->
                    <?php
                    require_once('../../dam/admin/dao/loai-hang.php');
                    extract($_REQUEST);
    ...
    <script type="text/javascript">
        const nextIcons = ' <i class="fa fa-chevron-left" style="font-size:36px;color:black"></i>';
        const preIconz = ' <i class="fa fa-chevron-right" style="font-size:36px;color:black"></i>';
        $('.owl-carousel').owlCarousel({
            loop: true,
            margin: 10,
            responsiveClass: true,
