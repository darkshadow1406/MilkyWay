...
<body>
	...
	<?php
		...
		if(array_key_exists('btn_register',$_REQUEST)){
			khach_hang_insert($ma_kh,$ho_ten,$mat_khau,$email,$dia_chi,0);
		...
		<div class="container-login100" style="background-image: url('../css/tai-khoan/images/bg-01.jpg');">
			<div class="wrap-login100">
				<form class="login100-form validate-form" method = "post">
					...
					<a href="/index.php"><img src="../css/tai-khoan/images/logo12.jpg" width = "80px" alt=""></a>
					</span>
					...
					<div class="wrap-input100 validate-input" data-validate="Enter Họ và tên">
					...
					<div class="wrap-input100 validate-input" data-validate="Enter Địa chỉ">
