...
<body>
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="../../../../dam/tai-khoan/dang-xuat.php"><i class="fa fa-sign-out fa-fw"></i> Đăng xuất</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
                        ...
                        <div class="page-header">
                            ...
                            <?php
                                ...
                                if(array_key_exists("btn_insert",$_REQUEST)){
                                    ...
                                    khach_hang_insert($ma_kh,$ho_ten,$mat_khau,$email,$dia_chi,$vai_tro);
                                    unset($ma_kh,$ho_ten_,$mat_khau,$email,$dia_chi);
                                }
                            ?>
                            <!-- /. CONTENT  -->
                            <a href="khach-hang-list.php"><button class="btn btn-primary">Danh Sách</button></a>
    ...
    let x = document.forms["myForm"]["ma_kh"].value;
    let y = document.forms["myForm"]["ho_ten"].value;
    let z = document.forms["myForm"]["mat_khau"].value;
    let a = document.forms["myForm"]["email"].value;
    let b = document.forms["myForm"]["dia_chi"].value;
    if ( x==""&&y==""&&z==""&&a==""&&b=="") {
    ...
    return false;
        ...
        if (b == "") {
    alert("Mời bạn cung cấp địa chỉ");
    return false;
        }
    }       
    </script>
