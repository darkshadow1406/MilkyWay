...
<body>
                        ...
                        <div class="page-header">
                            ...
                            <?php
                                ...
                                if(array_key_exists("btn_insert",$_REQUEST)){
                                    $up_hinh = save_file("hinh", "../../../../dam/css/admin/images/products/");
                                    $hinh = strlen($up_hinh) > 0 ? $up_hinh : 'product.png';

                                    hang_hoa_insert($ten_hh,$hinh,$don_gia,$giam_gia,$mo_ta,$ma_loai,$size,$mauSac);
                                    unset($ten_hh,$hinh,$don_gia,$giam_gia,$mo_ta,$ma_loai,$size,$mauSac);
                                }
                            ?>
                            <!-- /. CONTENT  -->
                            <a href="hang-hoa-list.php"><button class="btn btn-primary">Danh Sách</button></a>
                          ...
                          <a href="/admin/index.php"><button type="submit" name="btn_insert" class="btn btn-primary">Thêm mới</button></a>  
    ...
    let x = document.forms["myForm"]["ten_hh"].value;
    let y = document.forms["myForm"]["don_gia"].value;
    let z = document.forms["myForm"]["giam_gia"].value;
    let a = document.forms["myForm"]["hinh"].value;
    let b = document.forms["myForm"]["mo_ta"].value;
    if (x == "") {
    alert("Mời bạn nhập tên hàng hóa");
    return false;
        }
        if (y == "") {
    alert("Mời bạn nhập giá hàng hóa");
    return false;
        }
        if (z == "") {
    alert("Mời bạn nhập giảm giá");
    return false;
        }
        if (a == "") {
    alert("Mời bạn thêm hình ảnh");
    return false;
        }
        if (b == "") {
