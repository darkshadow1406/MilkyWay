                        ...
                        <div class="page-header">
                            ...
                            <?php
                                ...
                                if(array_key_exists("btn_update",$_REQUEST)){
                                    ...
                                    hang_hoa_update($ma_hh, $ten_hh, $don_gia, $giam_gia, $hinh, $ma_loai, $mo_ta, $size, $mauSac);   
                                }

                            ?>
                            <!-- /. CONTENT  -->
                            <button  class="btn btn-danger"><a style="color:#fff"; href="hang-hoa-list.php">Danh Sách</a></button>
                            ...
                            <select name="ma_loai" value="<?=$ma_loai?>" class=form-control>
                                            <?php
                            ...
                            <select name="size" value="<?=$maSize?>" class=form-control>
                                            <?php
                                                $size_select_list = size_select_all();
                                                foreach ($size_select_list as $size) {
                                                    if($size['maSize'] == $maSize){
                                                        echo '<option selected value="'.$size['maSize'].'">'.$size['Size'].'</option>';
                                                    }
                                                    else{
                            ...
                            <select name="mauSac" value="<?=$maMau?>" class=form-control>
                                            <?php
                                                $color_select_list = color_select_all();
                                                foreach ($color_select_list as $color) {
                                                    if($color['maMau'] == $maMau){
                                                        echo '<option selected value="'.$color['maMau'].'">'.$color['Mau'].'</option>';
                                                    }
                                                    else{
