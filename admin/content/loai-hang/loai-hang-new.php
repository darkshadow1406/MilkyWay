...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../../../../dam/trang-chinh/"><strong style = "margin-left: 40px;">MILKY WAY</strong></a>
            </div>
        ...
        <div id="page-wrapper">
		  <div class="header"> 
                        <div class="page-header">
                            ...
                            ?>
                            <!-- /. CONTENT  -->
                            <a href="loai-hang-list.php"><button class="btn btn-primary">Danh Sách</button></a>
                            <form action="" name="myForm" onsubmit="return validateForm()" method="POST">
                                <div class="form-group">
                                <label for="" name="ten_loai">Tên loại:</label>
                                <input
                                    type="text"
                                    class="form-control"
    ...
    let x = document.forms["myForm"]["ten_loai"].value;
    if (x == "") {
    alert("Mời bạn nhập tên loại hàng");
    return false;
        }
    }       
    </script>
